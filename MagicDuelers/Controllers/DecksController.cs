...
namespace MagicDuelers.Controllers
{
    ...
    {
        private readonly MvcDeckContext _context;

        public DecksController(MvcDeckContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] Deck deck)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Deck deck)
        {
            if (id != deck.Id)
            {
                return NotFound();
